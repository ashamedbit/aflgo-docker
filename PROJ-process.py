...
def identify_crash_line(asan_output, file, time):
        ...
        for line in lines:
            ...
            if m:
                issue = m[0]
                crash_detected = 1
            elif "==ERROR: AddressSanitizer: negative-size-param:" in line:
                issue = "negative-size-param"
                crash_detected = 1
...
# Result of first binary
bin_file = "./PROJ/obj-aflgo/standard_fuzzer"
outpath = "./PROJ/obj-aflgo/out"
...
print(min_value, max_value, (max_value - min_value)/(3600*24))  # Output: 5 30
